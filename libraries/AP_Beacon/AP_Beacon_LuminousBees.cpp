...
static const char message_name[10] = "LBRawPos";


// constructor
AP_Beacon_LuminousBees::AP_Beacon_LuminousBees(AP_Beacon &frontend) :
...
void AP_Beacon_LuminousBees::update(void)
{
    ...
    if (uart != nullptr) {
        uint32_t nbytes = MIN(uart->available(), 64);
